...
# def get_proxy():
#     data_json = requests.get("http://118.24.52.95/get/").text
#     data = json.loads(data_json)
#     return data['data']['proxy']


# def get_proxy():
#     data_json = requests.get("https://www.proxyscan.io/api/proxy?type=http",timeout=3).text
#     # data = json.loads(data_json)
#
#     ip = re.findall(r'"Ip": "(.+?)",',data_json)[0]
#     port = re.findall(r'"Port": (\d+?),', data_json)[0]
#     return ip+":"+port
